from pages_ozon.config import url
...
class StartLab():
    ...
    def lab_title(self):
        return self.driver.find_element_by_xpath('//*[@id="minwidth"]/div[5]/div[1]/div[1]/div[1]/div/a[1]')
